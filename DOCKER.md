...
# Specific version
VERSION=1.4.1 make docker-build

# Without cache
docker compose build --no-cache

# Multi-platform
docker buildx build --platform linux/amd64,linux/arm64 -t maxiofs:1.4.1 .
```
...
- **MaxIOFS**: `maxiofs/maxiofs:latest` — also available as `maxiofs/maxiofs:1.4.1`
