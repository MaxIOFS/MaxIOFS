  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'soft-md': '0 4px 6px -1px rgb(0 0 0 / 0.07), 0 2px 4px -1px rgb(0 0 0 / 0.06)',
        'soft-lg': '0 10px 15px -3px rgb(0 0 0 / 0.07), 0 4px 6px -2px rgb(0 0 0 / 0.05)',
        'soft-xl': '0 20px 25px -5px rgb(0 0 0 / 0.07), 0 10px 10px -5px rgb(0 0 0 / 0.04)',
        'card': '0 4px 12px rgb(0 0 0 / 0.12), 0 1px 4px rgb(0 0 0 / 0.08)',
        'card-hover': '0 8px 24px rgb(0 0 0 / 0.15), 0 2px 8px rgb(0 0 0 / 0.10)',
        'float': '0 8px 32px rgb(0 0 0 / 0.18), 0 2px 8px rgb(0 0 0 / 0.12)',
        'float-lg': '0 16px 48px rgb(0 0 0 / 0.22), 0 4px 16px rgb(0 0 0 / 0.14)',
        'glow': '0 0 15px rgb(70 95 255 / 0.25)',
        'glow-sm': '0 0 10px rgb(70 95 255 / 0.15)',
      },
      borderRadius: {
        'card': '20px',
        'button': '10px',
