    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="text-center max-w-md p-8">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{t('oauthFailed')}</h2>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
      <div className="text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">{t('completingSignIn')}</p>
      </div>
    </div>
  );
}
