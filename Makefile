...
help:
	...
	@echo "  make deb VERSION=v0.9.0-beta                   - Build Debian AMD64 package"
	@echo "  make deb-arm64 VERSION=v0.9.0-beta             - Build Debian ARM64 package"
	@echo "  make rpm VERSION=v0.9.0-beta                   - Build RPM AMD64 package"
	@echo "  make rpm-arm64 VERSION=v0.9.0-beta             - Build RPM ARM64 package"
